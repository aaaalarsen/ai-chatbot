...
export default function MessageBubble({ 
  ...
  return (
    <div className={`flex ${isBot ? 'justify-start' : 'justify-end'} mb-6 animate-[slideInUp_0.5s_ease-out]`}>
      <div className={`max-w-[80%] relative group ${
        isBot ? 'order-1' : 'order-2'
      }`}>
        {/* Message bubble */}
        <div className={`
          relative px-6 py-4 rounded-3xl shadow-lg backdrop-blur-sm transition-all duration-300 transform group-hover:scale-[1.02]
          ${isBot
        ...
        {/* Avatar for bot */}
        {isBot && (
          <div className="absolute -left-12 top-0 w-10 h-10 rounded-full bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center text-white shadow-lg">
