...
import VercelDeploy from '@/components/Management/VercelDeploy'

type ManagementTab = 'preview' | 'edit' | 'settings' | 'deploy'
  ...
  return (
    <div className="min-h-screen bg-gray-50">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-4">
              ...
              {envCheck && (
                <span className={`px-3 py-1 rounded-full text-xs ${
                  envCheck.ENABLE_MANAGEMENT === 'false' 
                    ? 'bg-red-100 text-red-800' 
                    : 'bg-green-100 text-green-800'
                }`}>
                  ENABLE_MANAGEMENT: {envCheck.ENABLE_MANAGEMENT || 'undefined'}
                </span>
              )}
            </div>
      ...
      <main className="max-w-7xl mx-auto py-4 px-4 sm:py-6 sm:px-6 lg:px-8">
        ...
        {activeTab === 'deploy' && (
          <VercelDeploy flowData={flowData} />
        )}
